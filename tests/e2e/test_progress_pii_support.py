...
def test_progress_36_rls_read_other(new_user, service_client, valid_task_rule_id):
...
def test_progress_37_rls_update_other(new_user, service_client, valid_task_rule_id):
    other_client = create_client(SUPABASE_URL, SUPABASE_ANON_KEY)
    other_res = other_client.auth.sign_in_anonymously()
    other_uid = other_res.user.id
...
def test_progress_38_rls_delete_other(new_user, service_client, valid_task_rule_id):
    other_client = create_client(SUPABASE_URL, SUPABASE_ANON_KEY)
    other_res = other_client.auth.sign_in_anonymously()
    other_uid = other_res.user.id
...
def test_pii_48_verify_support_thread_subject_blocked(new_user):
    client = new_user["client"]
    with pytest.raises(APIError) as exc_info:
...
def test_pii_49_verify_support_message_body_blocked(new_user):
    client = new_user["client"]
    uid = new_user["id"]
...
def test_support_51_thread_creation_success(new_user):
    client = new_user["client"]
    uid = new_user["id"]
...
def test_support_52_message_allowed(new_user):
    client = new_user["client"]
    uid = new_user["id"]
...
def test_support_53_message_disallowed(new_user):
    client = new_user["client"]
    uid = new_user["id"]
...
def test_support_54_thread_read_own(new_user):
    client = new_user["client"]
    uid = new_user["id"]
...
def test_support_55_thread_rls_read_other(new_user, service_client):
    other_client = create_client(SUPABASE_URL, SUPABASE_ANON_KEY)
    other_res = other_client.auth.sign_in_anonymously()
    other_uid = other_res.user.id
...
def test_support_56_message_rls_read_other(new_user, service_client):
    other_client = create_client(SUPABASE_URL, SUPABASE_ANON_KEY)
    other_res = other_client.auth.sign_in_anonymously()
    other_uid = other_res.user.id
...
def test_support_57_persist_ai_reply_success(new_user, service_client):
    client = new_user["client"]
    uid = new_user["id"]
...
def test_support_58_persist_ai_reply_fails_on_wrong_message_id(new_user, service_client):
    client = new_user["client"]
    uid = new_user["id"]
...
def test_support_59_takeover_blocks_ai_reply(new_user, service_client):
    client = new_user["client"]
    uid = new_user["id"]
...
def test_support_60_reopen_thread(new_user, service_client):
    client = new_user["client"]
    uid = new_user["id"]
